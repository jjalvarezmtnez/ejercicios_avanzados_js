...
para hacer la media del volumen de todos los
...
function volumeAverage(users){
  ...
  for (const user of users){
    amountOfSounds += Object.keys(user.favoritesSounds).length;
  ...
  volumeAverage = volumeTotal / amountOfSounds;
  return volumeAverage;
};

console.log(`La media del volumen es ${volumeAverage(users)}`);