...
el numero de caras que queramos que tenga el dado que deberá
simular el codigo dentro de la función.
Que la función use el parametro para simular una tirada
de dado y retornar el resultado.
...
function rollDice(sidesOfDice){
  return parseInt(Math.random() * sidesOfDice) + 1;
};
